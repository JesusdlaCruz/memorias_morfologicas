...
carpeta_max = os.path.join(ruta_raiz, 'salida_max_ruido')
carpeta_min = os.path.join(ruta_raiz, 'salida_min_ruido')
carpeta_entradas = os.path.join(ruta_raiz, 'img_ruido')
